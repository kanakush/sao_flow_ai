...
def main():
    ...
    superapp_pattern = 'Баги, тех. ошибки|'
    df_superapp = df_all[df_all['TEH'].fillna('').str.contains( superapp_pattern, case=False)].copy()
    ...
    if not df_superapp.empty:
        loop.run_until_complete(process_category(df_superapp, "SUPERAPP", week_label))
    print("\n✅ Готово.")
